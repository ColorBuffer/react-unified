...
var N = require('react-native');
var N__default = _interopDefault(N);
var _extends = _interopDefault(require('@babel/runtime/helpers/extends'));
var _objectWithoutPropertiesLoose = _interopDefault(require('@babel/runtime/helpers/objectWithoutPropertiesLoose'));
var reactUnified = require('react-unified');
...
function StatusBar(_ref) {
  ...
  return React.createElement(N__default.StatusBar, {
...
function Center(_ref) {
  ...
  return React.createElement(reactUnified.View, _extends({
    style: _extends({
...
React.forwardRef(function (_ref, ref) {
  ...
  return React.createElement(N__default.TouchableWithoutFeedback, {
  ...
  }, React.createElement(N__default.View, {
    style: style,
    ref: ref
  }, children));
});
...
function useDimensionsNative(dim) {
  ...
  var initial = N__default.Dimensions.get(dim);
  ...
  React.useEffect(function () {
    ...
    N__default.Dimensions.addEventListener('change', updateDimensions);
    return function () {
      return N__default.Dimensions.removeEventListener('change', updateDimensions);
    };
  }, []);
  return dimensions;
}
...
function PlaceholderView(_ref) {
  ...
  return React.createElement(reactUnified.View, {
...
function Image(_ref) {
  ...
  return source ? React.createElement(N__default.Image, {
    source: {
      uri: source
    },
...
React.forwardRef(function (_ref, ref) {
  ...
  return React.createElement(N__default.TextInput, {
    ref: ref,
    spellCheck: false,
    autoCorrect: false,
    autoFocus: autoFocus,
...
React.forwardRef(function (_ref, ref) {
  var onPress = _ref.onPress,
      style = _ref.style,
      children = _ref.children;
  var T = N__default.TouchableWithoutFeedback;
...
React.forwardRef(function List(_ref, ref) {
  ...
  return React.createElement(N__default.FlatList, {
    ref: ref,
    style: {
      height: '100%',
      width: '100%',
    ...
    renderItem: function renderItem(_ref2) {
      var item = _ref2.item,
          index = _ref2.index;
      return React.createElement(reactUnified.View, null, index === 0 && topper ? topper : null, onlyTopper ? null : _renderItem(item, index));
    },
...
var NoUserSelect_native = N__default.View;
...
function SidebarSafe(_ref) {
  ...
  var dimensions = reactUnified.useDimensions();
  ...
  }, React.createElement(reactUnified.View, {
    style: _extends({
...
Svg__default.Path = Svg.Path;
Svg__default.G = Svg.G;
Svg__default.Polygon = Svg.Polygon;
...
function Text(_ref) {
  ...
  var fontCtx = React.useContext(FontContext);
  return React.createElement(N__default.Text, _extends({
...
React.forwardRef(function (_ref, ref) {
  ...
  return React.createElement(N__default.View, _extends({
    ref: ref,
    style: _extends({}, style)
  }, props));
});
...
exports.Audio = Audio_native;
exports.Button = Button;
exports.Center = Center;
exports.CopyToClipboard = CopyToClipboard_native;
exports.CropField = CropField;
exports.FilePicker = FilePicker;
exports.FontProvider = FontProvider;
exports.Form = Form;
exports.HList = HList;
exports.Image = Image;
exports.ImageZoom = Image;
exports.Input = Input;
exports.Link = Link;
exports.List = List_native;
exports.ListReversed = ListReversed;
exports.Modal = Modal;
exports.NavContext = NavContext;
exports.NoUserSelect = NoUserSelect_native;
exports.PageTitle = PageTitle;
exports.ScrollView = ScrollView;
exports.Sidebar = Sidebar;
exports.SidebarSafe = SidebarSafe;
exports.StatusBar = StatusBar;
exports.Storage = Storage;
exports.Svg = Svg__default;
exports.Text = Text;
exports.Touch = Touch;
exports.Video = Video_native;
exports.View = View;
exports.copyToClipboard = copyToClipboard;
exports.useActive = useActive;
exports.useDimensions = useDimensionsNative;
exports.useFocus = useFocus;
exports.useHover = useHover;
exports.useLegacyState = useLegacyState;
exports.usePassiveState = usePassiveState;
