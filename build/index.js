...
var IM = _interopDefault(require('react-medium-image-zoom'));
var TextArea = _interopDefault(require('react-textarea-autosize'));
var router = require('next/router');
var L = _interopDefault(require('next/link'));
...
function useRouter() {
  ...
  return {
    getPathname: function getPathname() {
      return router$1.route;
    },
    getQuery: function getQuery(name, defaultValue) {
      if (router$1.query[name] === undefined) {
        return defaultValue;
      }

      return router$1.query[name];
    },
    events: router$1.events,
    push: router$1.push,
    replace: router$1.replace,
    back: router$1.back
  };
}
  ...
  return React.createElement(AutoSizer, null, function (_ref3) {
    ...
    return React.createElement(InfiniteLoader, {
      ...
      var onItemsRendered = _ref4.onItemsRendered,
          _ref5 = _ref4.ref;
      return React.createElement(reactWindow.DynamicSizeList, {
        ref: function ref(el) {
          _ref5(el);
...
function Sidebar(_ref) {
  ...
  }, children), React.createElement(reactUnified.View, {
    style: {
      position: 'fixed',
      top: 0,
      bottom: 0,
...
exports.NoUserSelect = NoUserSelect;
